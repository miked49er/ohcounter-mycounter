...
function addDataset(elem, counter) {
  ...
  elem.dataset.min = counter.min;
  elem.dataset.max = counter.max;
...
function increment(elem){
  ...
  // if (data.min !== null) {
  //   console.log((parseInt(cvalue, 10) >= parseInt(data.min, 10)) ? cvalue : data.min);
  //   cvalue = (parseInt(cvalue, 10) >= parseInt(data.min, 10)) ? cvalue : data.min;
  // }
  // if (data.max !== null) {
  //   cvalue = (parseInt(cvalue, 10) <= parseInt(value.dataset.max, 10)) ? cvalue : value.dataset.max;
  // }
