            ...
            loadFileContents("lib/json/" + c).then(function(a) {
                for (var b = JSON.parse(a), c = 0; c < 1; c++) {
                    ...
                    for (var s = b.tertiary, t = 0; t < s.length; t++) {
                        ...
                        g = u.increments[0], h = e.getElementsByClassName("loss")[0], h.innerHTML = void 0 !== g ? g : u.increments, 
                        h.dataset.counter = u.id, i = e.getElementsByClassName("gain")[0], i.innerHTML = void 0 !== g ? g : u.increments, 
                        i.dataset.counter = u.id, appendChildNodes(e, d);
                    }
                }
            });
        });
...
function increment(a) {
    ...
    c = parseInt(c, 10) + parseInt(d, 10), b.innerHTML = c;
}
