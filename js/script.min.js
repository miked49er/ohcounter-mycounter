    ...
    document.getElementById("content").innerHTML = "", loadFile("templates", "template/game.html").then(function(b) {
        ...
        loadFileContents("lib/json/game-list.json").then(function(b) {
            ...
            loadFileContents("lib/json/" + c).then(function(b) {
                for (var c = JSON.parse(b), d = a.numPlayers, e = 0; e < d; e++) {
                    var f = document.createElement("div");
                    f.setAttribute("id", "player" + e), f.classList.add("player"), 0 === e && f.classList.add("active"), 
                    document.getElementById("content").appendChild(f);
                    var g, h, i, j, k, l = c.primary;
                    if (l.increments.length > 1) {
                        g = convertToElement(document.getElementById("p-multi-template").innerHTML), g.getElementsByClassName("counter-name")[0].innerHTML = l.name;
                        var m = g.getElementsByClassName("counter-value")[0];
                        m.innerHTML = l.start, m.setAttribute("id", l.id);
                        for (var n = g.getElementsByClassName("multi-counter")[0], o = 0; o < l.increments.length; o++) h = convertToElement(document.getElementById("increment-group-template").innerHTML), 
                        j = h.getElementsByClassName("loss")[0], j.innerHTML = l.increments[o], j.dataset.counter = l.id, 
                        k = h.getElementsByClassName("gain")[0], k.innerHTML = l.increments[o], k.dataset.counter = l.id, 
                        appendChildNodes(h, n);
                        appendChildNodes(g, f);
                    } else g = convertToElement(document.getElementById("p-single-template").innerHTML), 
                    g.getElementsByClassName("counter-name")[0].innerHTML = l.name, g.getElementsByClassName("counter-value")[0].innerHTML = l.start, 
                    g.getElementsByClassName("loss")[0].innerHTML = l.increments[0], g.getElementsByClassName("gain")[0].innerHTML = l.increments[0], 
                    appendChildNodes(g, f);
                    for (var p = c.secondary, q = 0; q < p.length; q++) {
                        var r = p[q];
                        if (r.increments.length > 1) {
                            g = convertToElement(document.getElementById("s-multi-template").innerHTML), g.getElementsByClassName("counter-name")[0].innerHTML = r.name, 
                            g.getElementsByClassName("counter-value")[0].innerHTML = r.start;
                            for (var s = g.getElementsByClassName("multi-counter")[0], t = 0; t < r.increments.length; t++) h = convertToElement(document.getElementById("increment-group-template").innerHTML), 
                            h.getElementsByClassName("loss")[0].innerHTML = r.increments[t], h.getElementsByClassName("gain")[0].innerHTML = r.increments[t], 
                            appendChildNodes(h, s);
                            appendChildNodes(g, f);
                        } else g = convertToElement(document.getElementById("s-single-template").innerHTML), 
                        g.getElementsByClassName("counter-name")[0].innerHTML = r.name, g.getElementsByClassName("counter-value")[0].innerHTML = r.start, 
                        i = r.increments[0], g.getElementsByClassName("loss")[0].innerHTML = void 0 !== i ? i : r.increments, 
                        g.getElementsByClassName("gain")[0].innerHTML = void 0 !== i ? i : r.increments, 
                        appendChildNodes(g, f);
                    }
                    for (var u = c.tertiary, v = 0; v < u.length; v++) {
                        var w = u[v];
                        g = convertToElement(document.getElementById("t-single-template").innerHTML), g.getElementsByClassName("counter-name")[0].innerHTML = w.name, 
                        g.getElementsByClassName("counter-value")[0].innerHTML = w.start, i = w.increments[0], 
                        g.getElementsByClassName("loss")[0].innerHTML = void 0 !== i ? i : w.increments, 
                        g.getElementsByClassName("gain")[0].innerHTML = void 0 !== i ? i : w.increments, 
                        appendChildNodes(g, f);
                    }
                }
            });
