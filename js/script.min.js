...
function revealShape(e) {
    e.getElementsByClassName(e.dataset.shape)[0].classList.add("opened"), setTimeout(function() {
        document.getElementsByClassName("opened")[0].classList.remove("opened");
    }, 550);
}
...
function shrinkElement(e) {
    e.classList.add("grow"), setTimeout(function() {
...
function buttonActionPrompt() {
    switch (whichIsChecked(document.getElementsByName("action-prompt-selection")).value) {
      case "resume":
        checkCookie(recentGameCookie) ? openGame(getCookie(recentGameCookie)) : (startNewGame(), 
...
function menuReturnToGame() {
    toggleHamMenu(), openGame(getCookie(recentGameCookie));
}
...
function rollDie(e) {
    ...
    document.getElementById("result").innerHTML = t, shrinkElement(document.getElementsByClassName("dice-result")[0]);
}
...
function coinFlip() {
    ...
    document.getElementById("result").innerHTML = 1 == e ? "Heads" : "Tails", shrinkElement(document.getElementsByClassName("dice-result")[0]);
}
...
function setUpGame(h) {
    loadFile("templates", "template/game.html").then(function(e) {
        var t = h.length, n = document.createElement("div");
        ...
        for (var l = 0; l < t; l++) {
            var i = h[l], s = convertToElement(document.getElementById("player-tab-template").innerHTML);
            ...
            var u = i.primary;
            1 < u.increments.length ? createCounterGroup("p-multi-template", u, d, l, h) : createCounter("p-single-template", u, d, l, h);
            for (var g = i.secondary, p = 0; p < g.length; p++) {
                var y = g[p];
                1 < y.increments.length ? createCounterGroup("s-multi-template", y, d, l, h) : createCounter("s-single-template", y, d, l, h);
            }
            for (var f = i.tertiary, v = 0; v < f.length; v++) {
                createCounter("t-single-template", f[v], d, l, h);
            }
...
function createCounter(e, t, n, a, o) {
    if (t.otherPlayers) for (var r = 0; r < o.length; r++) r !== a && counterSetup(e, t, n, a, o[r]); else counterSetup(e, t, n, a);
}

function counterSetup(e, t, n, a, o) {
    var r = null;
    r = t.otherPlayers ? createCounterValueGroup(e, t, a, o) : createCounterValueGroup(e, t, a);
    var l = t.increments[0];
    createIncrement(r, "loss", l, t), createIncrement(r, "gain", l, t), appendChildNodes(r, n);
}

function createCounterValueGroup(e, t, n, a) {
    var o = convertToElement(document.getElementById(e).innerHTML);
    o.getElementsByClassName("counter-name")[0].innerHTML = t.otherPlayers ? a.playerName + " " + t.name : t.name;
    var r = o.getElementsByClassName("counter-value")[0];
    return r.innerHTML = t.value, addDataset(r, t, n), o;
}
...
function toggleHamMenu() {
    toggleShow("menu"), toggleCover("menu-active"), toggleMenuOptions();
}

function toggleMenuOptions() {
    checkCookie(recentGameCookie) ? (document.getElementById("menuReturnGame").classList.toggle("hide", !1), 
    document.getElementById("menuRandPlayer").classList.toggle("hide", !1), document.getElementById("menuResetGame").classList.toggle("hide", !1)) : (document.getElementById("menuReturnGame").classList.toggle("hide", !0), 
    document.getElementById("menuRandPlayer").classList.toggle("hide", !0), document.getElementById("menuResetGame").classList.toggle("hide", !0));
}
