...
function newGame() {
    toggleHamMenu(), openGameSelect(getCookie(newGameCookie));
}
        ...
        loadFileContents("lib/json/game-list.json").then(function(b) {
            ...
            loadFileContents("lib/json/" + c).then(function(a) {
                for (var b = JSON.parse(a), c = 0; c < 1; c++) {
                    ...
                    var e, f, g, h, i, j, k = b.primary;
                    if (k.increments.length > 1) {
                        e = convertToElement(document.getElementById("p-multi-template").innerHTML), e.getElementsByClassName("counter-name")[0].innerHTML = k.name, 
                        j = e.getElementsByClassName("counter-value")[0], j.innerHTML = k.start, j.setAttribute("id", k.id), 
                        addDataset(j, k);
                        for (var l = e.getElementsByClassName("multi-counter")[0], m = 0; m < k.increments.length; m++) f = convertToElement(document.getElementById("increment-group-template").innerHTML), 
                        h = f.getElementsByClassName("loss")[0], h.innerHTML = k.increments[m], h.dataset.counter = k.id, 
                        i = f.getElementsByClassName("gain")[0], i.innerHTML = k.increments[m], i.dataset.counter = k.id, 
                        appendChildNodes(f, l);
                        appendChildNodes(e, d);
                    } else e = convertToElement(document.getElementById("p-single-template").innerHTML), 
                    e.getElementsByClassName("counter-name")[0].innerHTML = k.name, j = e.getElementsByClassName("counter-value")[0], 
                    j.innerHTML = k.start, j.setAttribute("id", k.id), h = f.getElementsByClassName("loss")[0], 
                    h.innerHTML = k.increments[0], h.dataset.counter = k.id, i = f.getElementsByClassName("gain")[0], 
                    i.innerHTML = k.increments[0], i.dataset.counter = k.id, appendChildNodes(e, d);
                    for (var n = b.secondary, o = 0; o < n.length; o++) {
                        var p = n[o];
                        if (p.increments.length > 1) {
                            e = convertToElement(document.getElementById("s-multi-template").innerHTML), e.getElementsByClassName("counter-name")[0].innerHTML = p.name, 
                            j = e.getElementsByClassName("counter-value")[0], j.innerHTML = p.start, j.setAttribute("id", p.id), 
                            addDataset(j, p);
                            for (var q = e.getElementsByClassName("multi-counter")[0], r = 0; r < p.increments.length; r++) f = convertToElement(document.getElementById("increment-group-template").innerHTML), 
                            h = f.getElementsByClassName("loss")[0], h.innerHTML = p.increments[r], h.dataset.counter = p.id, 
                            i = f.getElementsByClassName("gain")[0], i.innerHTML = p.increments[r], i.dataset.counter = p.id, 
                            appendChildNodes(f, q);
                            appendChildNodes(e, d);
                        } else e = convertToElement(document.getElementById("s-single-template").innerHTML), 
                        e.getElementsByClassName("counter-name")[0].innerHTML = p.name, j = e.getElementsByClassName("counter-value")[0], 
                        j.innerHTML = p.start, j.setAttribute("id", p.id), g = p.increments[0], h = e.getElementsByClassName("loss")[0], 
                        h.innerHTML = void 0 !== g ? g : p.increments, h.dataset.counter = p.id, i = e.getElementsByClassName("gain")[0], 
                        i.innerHTML = void 0 !== g ? g : p.increments, i.dataset.counter = p.id, appendChildNodes(e, d);
                    }
                    for (var s = b.tertiary, t = 0; t < s.length; t++) {
                        var u = s[t];
                        e = convertToElement(document.getElementById("t-single-template").innerHTML), e.getElementsByClassName("counter-name")[0].innerHTML = u.name, 
                        j = e.getElementsByClassName("counter-value")[0], j.innerHTML = u.start, j.setAttribute("id", u.id), 
                        addDataset(j, u), g = u.increments[0], h = e.getElementsByClassName("loss")[0], 
                        h.innerHTML = void 0 !== g ? g : u.increments, h.dataset.counter = u.id, i = e.getElementsByClassName("gain")[0], 
                        i.innerHTML = void 0 !== g ? g : u.increments, i.dataset.counter = u.id, appendChildNodes(e, d);
                    }
                }
            });
        });
...
function addDataset(a, b) {
    a.dataset.start = b.start, a.dataset.min = b.min, a.dataset.max = b.max, a.dataset.value = b.value;
}

function increment(a) {
    var b = document.getElementById(a.dataset.counter), c = b.innerHTML, d = a.classList.contains("loss") ? "-" + a.innerHTML : a.innerHTML;
    c = parseInt(c, 10) + parseInt(d, 10), data = b.dataset, b.innerHTML = c;
}
...
document.addEventListener("DOMContentLoaded", function() {
    loadFileContents("lib/json/game-creation-cookie-template.json").then(function(a) {
        var b = JSON.parse(a);
        b.numPlayers = 1, newCookie(newGameCookie, b, .0069), openGameSelect(b);
