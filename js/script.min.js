        ...
        loadFileContents("lib/json/game-list.json").then(function(b) {
            ...
            loadFileContents("lib/json/" + c).then(function(a) {
                for (var b = JSON.parse(a), c = 0; c < 1; c++) {
                    ...
                    j.innerHTML = k.start, j.setAttribute("id", k.id), h = e.getElementsByClassName("loss")[0], 
                    h.innerHTML = k.increments[0], h.dataset.counter = k.id, i = e.getElementsByClassName("gain")[0], 
