        ...
        loadFileContents("lib/json/game-list.json").then(function(b) {
            ...
            loadFileContents("lib/json/" + c).then(function(a) {
                for (var b = JSON.parse(a), c = 0; c < 1; c++) {
                    ...
                    var e, f, g, h, i, j = b.primary;
                    if (j.increments.length > 1) {
                        e = convertToElement(document.getElementById("p-multi-template").innerHTML), e.getElementsByClassName("counter-name")[0].innerHTML = j.name;
                        var k = e.getElementsByClassName("counter-value")[0];
                        k.innerHTML = j.start, k.setAttribute("id", j.id);
                        for (var l = e.getElementsByClassName("multi-counter")[0], m = 0; m < j.increments.length; m++) f = convertToElement(document.getElementById("increment-group-template").innerHTML), 
                        h = f.getElementsByClassName("loss")[0], h.innerHTML = j.increments[m], h.dataset.counter = j.id, 
                        i = f.getElementsByClassName("gain")[0], i.innerHTML = j.increments[m], i.dataset.counter = j.id, 
                        appendChildNodes(f, l);
                        appendChildNodes(e, d);
                    } else e = convertToElement(document.getElementById("p-single-template").innerHTML), 
                    e.getElementsByClassName("counter-name")[0].innerHTML = j.name, e.getElementsByClassName("counter-value")[0].innerHTML = j.start, 
                    e.getElementsByClassName("loss")[0].innerHTML = j.increments[0], e.getElementsByClassName("gain")[0].innerHTML = j.increments[0], 
                    appendChildNodes(e, d);
                    for (var n = b.secondary, o = 0; o < n.length; o++) {
                        ...
                        if (p.increments.length > 1) {
                            ...
                            e.getElementsByClassName("counter-value")[0].innerHTML = p.start;
                            ...
                            f.getElementsByClassName("loss")[0].innerHTML = p.increments[r], f.getElementsByClassName("gain")[0].innerHTML = p.increments[r], 
                            appendChildNodes(f, q);
                            appendChildNodes(e, d);
                        } else e = convertToElement(document.getElementById("s-single-template").innerHTML), 
                        e.getElementsByClassName("counter-name")[0].innerHTML = p.name, e.getElementsByClassName("counter-value")[0].innerHTML = p.start, 
                        g = p.increments[0], e.getElementsByClassName("loss")[0].innerHTML = void 0 !== g ? g : p.increments, 
                        e.getElementsByClassName("gain")[0].innerHTML = void 0 !== g ? g : p.increments, 
                        appendChildNodes(e, d);
                    }
                    for (var s = b.tertiary, t = 0; t < s.length; t++) {
                        ...
                        e.getElementsByClassName("counter-value")[0].innerHTML = u.start, g = u.increments[0], 
                        e.getElementsByClassName("loss")[0].innerHTML = void 0 !== g ? g : u.increments, 
                        e.getElementsByClassName("gain")[0].innerHTML = void 0 !== g ? g : u.increments, 
                        appendChildNodes(e, d);
                    }
                }
            });
