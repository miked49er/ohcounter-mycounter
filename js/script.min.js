...
function openGame(a) {
    document.getElementById("content").innerHTML = "", setUpGame(a);
}
...
document.addEventListener("DOMContentLoaded", function() {
    checkCookie(recentGameCookie) ? setUpGame(getCookie(recentGameCookie)) : loadFileContents("lib/json/game-creation-cookie-template.json").then(function(a) {
        var b = JSON.parse(a);
