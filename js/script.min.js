...
function checkCookie(a) {
    "" != getCookie(a) ? alert("Its back!") : (user = prompt("Please enter your name:", ""), 
    "" != user && null != user && setCookie("username", user, 365));
}
...
function domLoad(a) {
    ...
    switch (console.log("pop: " + b), b) {
      ...
      case "playerNames":
        enterPlayerNames(null.players.length, null);
        break;
...
document.addEventListener("DOMContentLoaded", function() {
    loadFileContents("lib/json/game-creation-cookie-template.json").then(function(a) {
        var b = JSON.parse(a);
        setCookie("GameInitCookie", b, .0069), openNumPlayerSelect(b);
