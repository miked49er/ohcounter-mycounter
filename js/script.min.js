        ...
        loadFileContents("lib/json/game-list.json").then(function(b) {
            ...
            loadFileContents("lib/json/" + c).then(function(a) {
                for (var b = JSON.parse(a), c = 0; c < 1; c++) {
                    ...
                    j.innerHTML = k.start, j.setAttribute("id", k.id), addDataset(j, k), h = e.getElementsByClassName("loss")[0], 
                    ...
                    for (var n = b.secondary, o = 0; o < n.length; o++) {
                        ...
                        j.innerHTML = p.start, j.setAttribute("id", p.id), addDataset(j, p), g = p.increments[0], 
                        h = e.getElementsByClassName("loss")[0], h.innerHTML = void 0 !== g ? g : p.increments, 
                        h.dataset.counter = p.id, i = e.getElementsByClassName("gain")[0], i.innerHTML = void 0 !== g ? g : p.increments, 
                        i.dataset.counter = p.id, appendChildNodes(e, d);
                    }
