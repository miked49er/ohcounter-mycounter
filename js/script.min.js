...
function randPlayer() {
    ...
    if (a.length > 0) {
        ...
        alert("Player", a[b].value, "anounce", 5e3);
...
window.alert = function(a, b, c, d) {
    var e = document.getElementsByClassName("alert")[0];
    e.getElementsByClassName("title")[0].innerHTML = void 0 !== a || null !== a ? a : "", 
    e.getElementsByClassName("message")[0].innerHTML = b, e.classList.toggle("hide", !1);
    var f = document.getElementById("alert-active");
    switch (f.classList.toggle("hide", !1), c) {
      case "anounce":
        e.classList.toggle("alert-anounce", !0), e.classList.toggle("alert-error", !1);
        break;

      case "error":
        e.classList.toggle("alert-anounce", !1), e.classList.toggle("alert-error", !0);
        break;

      default:
        e.classList.toggle("alert-anounce", !1), e.classList.toggle("alert-error", !1);
    }
    alertTimer = window.setTimeout(function() {
        e.classList.toggle("hide", !0), f.classList.toggle("hide", !0);
    }, void 0 !== d ? d : 5e3);
};
