    ...
    document.getElementById("content").innerHTML = "", console.log(a), loadFile("templates", "template/game.html").then(function(b) {
        ...
        loadFileContents("lib/json/game-list.json").then(function(b) {
            ...
            loadFileContents("lib/json/" + c).then(function(b) {
                ...
                f.classList.add("player-tabs"), f.classList.add("tabGroup1");
                var g = document.createElement("div");
                g.classList.add("player-tabs"), g.classList.add("tabGroup2");
                var h = document.createElement("div");
                h.setAttribute("id", "players");
                for (var i = 0; i < d; i++) {
                    var j = convertToElement(document.getElementById("player-tab-template").innerHTML);
                    j.getElementsByClassName("player-tab")[0].classList.add("player-tab-" + d);
                    var k = j.getElementsByTagName("label")[0];
                    k.setAttribute("for", "player" + i), k.innerHTML = a.playerNames[i];
                    var l = j.getElementsByTagName("input")[0];
                    l.setAttribute("id", "player" + i);
                    var m = document.createElement("div");
                    m.classList.add("player"), m.classList.add(l.id), 0 === i && (l.checked = !0);
                    var n, o, p, q, r, s, t = c.primary;
                    if (t.increments.length > 1) {
                        n = convertToElement(document.getElementById("p-multi-template").innerHTML), n.getElementsByClassName("counter-name")[0].innerHTML = t.name, 
                        s = n.getElementsByClassName("counter-value")[0], s.innerHTML = t.start, addDataset(s, t);
                        for (var u = n.getElementsByClassName("multi-counter")[0], v = 0; v < t.increments.length; v++) o = convertToElement(document.getElementById("increment-group-template").innerHTML), 
                        q = o.getElementsByClassName("loss")[0], q.innerHTML = t.increments[v], q.dataset.counter = t.id, 
                        r = o.getElementsByClassName("gain")[0], r.innerHTML = t.increments[v], r.dataset.counter = t.id, 
                        appendChildNodes(o, u);
                        appendChildNodes(n, m);
                    } else n = convertToElement(document.getElementById("p-single-template").innerHTML), 
                    n.getElementsByClassName("counter-name")[0].innerHTML = t.name, s = n.getElementsByClassName("counter-value")[0], 
                    s.innerHTML = t.start, addDataset(s, t), q = n.getElementsByClassName("loss")[0], 
                    q.innerHTML = t.increments[0], q.dataset.counter = t.id, r = n.getElementsByClassName("gain")[0], 
                    r.innerHTML = t.increments[0], r.dataset.counter = t.id, appendChildNodes(n, m);
                    for (var w = c.secondary, x = 0; x < w.length; x++) {
                        var y = w[x];
                        if (y.increments.length > 1) {
                            n = convertToElement(document.getElementById("s-multi-template").innerHTML), n.getElementsByClassName("counter-name")[0].innerHTML = y.name, 
                            s = n.getElementsByClassName("counter-value")[0], s.innerHTML = y.start, addDataset(s, y);
                            for (var z = n.getElementsByClassName("multi-counter")[0], A = 0; A < y.increments.length; A++) o = convertToElement(document.getElementById("increment-group-template").innerHTML), 
                            q = o.getElementsByClassName("loss")[0], q.innerHTML = y.increments[A], q.dataset.counter = y.id, 
                            r = o.getElementsByClassName("gain")[0], r.innerHTML = y.increments[A], r.dataset.counter = y.id, 
                            appendChildNodes(o, z);
                            appendChildNodes(n, m);
                        } else n = convertToElement(document.getElementById("s-single-template").innerHTML), 
                        n.getElementsByClassName("counter-name")[0].innerHTML = y.name, s = n.getElementsByClassName("counter-value")[0], 
                        s.innerHTML = y.start, addDataset(s, y), p = y.increments[0], q = n.getElementsByClassName("loss")[0], 
                        q.innerHTML = void 0 !== p ? p : y.increments, q.dataset.counter = y.id, r = n.getElementsByClassName("gain")[0], 
                        r.innerHTML = void 0 !== p ? p : y.increments, r.dataset.counter = y.id, appendChildNodes(n, m);
                    }
                    for (var B = c.tertiary, C = 0; C < B.length; C++) {
                        var D = B[C];
                        n = convertToElement(document.getElementById("t-single-template").innerHTML), n.getElementsByClassName("counter-name")[0].innerHTML = D.name, 
                        s = n.getElementsByClassName("counter-value")[0], s.innerHTML = D.start, addDataset(s, D), 
                        p = D.increments[0], q = n.getElementsByClassName("loss")[0], q.innerHTML = void 0 !== p ? p : D.increments, 
                        q.dataset.counter = D.id, r = n.getElementsByClassName("gain")[0], r.innerHTML = void 0 !== p ? p : D.increments, 
                        r.dataset.counter = D.id, appendChildNodes(n, m);
                    }
                    i > 3 ? appendChildNodes(j, g) : appendChildNodes(j, f), h.appendChild(m);
                }
                e.appendChild(f), d > 4 && e.appendChild(g), document.getElementById("content").appendChild(e), 
                document.getElementById("content").appendChild(h), document.getElementsByClassName("player")[0].classList.add("active");
            });
        });
    }), newState("game-start");
}
