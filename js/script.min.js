    ...
    document.getElementById("content").innerHTML = "", console.log(a), loadFile("templates", "template/game.html").then(function(b) {
        ...
        loadFileContents("lib/json/game-list.json").then(function(b) {
            ...
            loadFileContents("lib/json/" + c).then(function(b) {
                ...
                for (var f = 0; f < d; f++) {
                    var g = convertToElement(document.getElementById("player-tabs-template").innerHTML);
                    console.log(g);
                    var h = g.getElementsByClassName("player-tab")[0];
                    ...
                    0 === f && (j.checked = !0), document.getElementById("content").appendChild(k);
                    ...
                    appendChildNodes(k, e);
                }
                console.log(e), appendChildNodes(e, document.getElementById("content"));
            });
        });
    }), newState("game-start");
}
