...
function setUpGame(C) {
    loadFile("templates", "template/game.html").then(function(e) {
        ...
        for (var l = 0; l < t; l++) {
            ...
            var u = i.primary;
            1 < u.increments.length ? createCounterGroup("p-multi-template", u, d, l, C) : createCounter("p-single-template", u, d, l, C);
            for (var p = i.secondary, g = 0; g < p.length; g++) {
                var y = p[g];
                1 < y.increments.length ? createCounterGroup("s-multi-template", y, d, l, C) : createCounter("s-single-template", y, d, l, C);
            }
            for (var f = i.tertiary, v = 0; v < f.length; v++) {
                createCounter("t-single-template", f[v], d, l, C);
            }
