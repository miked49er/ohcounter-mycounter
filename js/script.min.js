            ...
            loadFileContents("lib/json/" + c).then(function(b) {
                ...
                for (var f = 0; f < d; f++) {
                    ...
                    if (r.increments.length > 1) {
                        ...
                        q = l.getElementsByClassName("counter-value")[0], q.innerHTML = r.start, addDataset(q, r);
                    ...
                    q.innerHTML = r.start, addDataset(q, r), o = l.getElementsByClassName("loss")[0], 
                    ...
                    for (var u = c.secondary, v = 0; v < u.length; v++) {
                        ...
                        if (w.increments.length > 1) {
                            ...
                            q = l.getElementsByClassName("counter-value")[0], q.innerHTML = w.start, addDataset(q, w);
                        ...
                        q.innerHTML = w.start, addDataset(q, w), n = w.increments[0], o = l.getElementsByClassName("loss")[0], 
                        o.innerHTML = void 0 !== n ? n : w.increments, o.dataset.counter = w.id, p = l.getElementsByClassName("gain")[0], 
                        p.innerHTML = void 0 !== n ? n : w.increments, p.dataset.counter = w.id, appendChildNodes(l, k);
                    }
                    for (var z = c.tertiary, A = 0; A < z.length; A++) {
                        ...
                        q = l.getElementsByClassName("counter-value")[0], q.innerHTML = B.start, addDataset(q, B), 
                        n = B.increments[0], o = l.getElementsByClassName("loss")[0], o.innerHTML = void 0 !== n ? n : B.increments, 
                        o.dataset.counter = B.id, p = l.getElementsByClassName("gain")[0], p.innerHTML = void 0 !== n ? n : B.increments, 
                        p.dataset.counter = B.id, appendChildNodes(l, k);
                    }
...
function activatePlayer() {
    for (var a = document.getElementById("player-tabs"), b = 0; b < a.childElementCount; b++) {
        var c = a.childNodes[b].getElementsByTagName("input")[0];
        c.parentNode.getElementsByClassName("player")[0].classList.toggle("active", c.checked);
    }
}
