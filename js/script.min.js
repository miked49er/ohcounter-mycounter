...
function openDice() {
    toggleHamMenu(), document.getElementById("content").innerHTML = "", loadFile("content", "template/dice.html", 1).then(function(a) {
        loadFile("dice-group", "images/dice/d4.svg", 1), loadFile("dice-group", "images/dice/d6.svg", 1), 
        loadFile("dice-group", "images/dice/d8.svg", 1), loadFile("dice-group", "images/dice/d10.svg", 1), 
        loadFile("dice-group", "images/dice/d12.svg", 1), loadFile("dice-group", "images/dice/d20.svg", 1), 
